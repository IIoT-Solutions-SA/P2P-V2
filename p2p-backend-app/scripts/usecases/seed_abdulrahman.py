...
# USER CONFIGURATION
USER_EMAIL = "abdulrahman@iiotsolutions.sa"
USER_NAME = "Abdulrahman Bajabir"
JSON_FILE = "abdulrahman_usecases.json"
...
async def seed_abdulrahman_usecases():
    """Seeds use cases for Abdulrahman Bajabir from abdulrahman_usecases.json"""
        ...
        for idx, case_json in enumerate(use_cases_data, 1):
            try:
                ...
                db_case = {
                    ...
                    "submitted_by": str(user.id),  # Assign to Abdulrahman
                    "published": True,
                    "view_count": 0,
                    "like_count": 0,
                    "bookmark_count": 0,
...
if __name__ == "__main__":
    ...
    print("-" * 50)
    asyncio.run(seed_abdulrahman_usecases())