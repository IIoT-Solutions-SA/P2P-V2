...
# USER CONFIGURATION
USER_EMAIL = "amro@iiotsolutions.sa"  # UPDATE THIS WITH ACTUAL EMAIL
USER_NAME = "Amro Abouzied"
JSON_FILE = "amro_usecases.json"
...
async def seed_amro_usecases():
    """Seeds use cases for Amro Abouzied from amro_usecases.json"""
        ...
        for idx, case_json in enumerate(use_cases_data, 1):
            try:
                ...
                db_case = {
                    ...
                    "submitted_by": str(user.id),  # Assign to Amro
                    "published": True,
                    "view_count": 0,
                    "like_count": 0,
                    "bookmark_count": 0,
...
if __name__ == "__main__":
    ...
    print("-" * 50)
    asyncio.run(seed_amro_usecases())