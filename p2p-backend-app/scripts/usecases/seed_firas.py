...
# USER CONFIGURATION
USER_EMAIL = "firas@iiotsolutions.sa"
USER_NAME = "Firas Al-Siddiqi"
JSON_FILE = "firas_usecases.json"
...
async def seed_firas_usecases():
    """Seeds use cases for Firas Al-Siddiqi from firas_usecases.json"""
        ...
        for idx, case_json in enumerate(use_cases_data, 1):
            try:
                ...
                db_case = {
                    ...
                    "submitted_by": str(user.id),  # Assign to Firas
                    "published": True,
                    "view_count": 0,
                    "like_count": 0,
                    "bookmark_count": 0,
...
if __name__ == "__main__":
    ...
    print("-" * 50)
    asyncio.run(seed_firas_usecases())