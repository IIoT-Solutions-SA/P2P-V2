...
# USER CONFIGURATION
USER_EMAIL = "hamad@iiotsolutions.sa"
USER_NAME = "Hamad Ali"
JSON_FILE = "hamad_usecases.json"
...
async def seed_hamad_usecases():
    """Seeds use cases for Hamad Ali from hamad_usecases.json"""
        ...
        for idx, case_json in enumerate(use_cases_data, 1):
            try:
                ...
                db_case = {
                    ...
                    "submitted_by": str(user.id),  # Assign to Hamad
                    "published": True,
                    "view_count": 0,
                    "like_count": 0,
                    "bookmark_count": 0,
...
if __name__ == "__main__":
    ...
    print("-" * 50)
    asyncio.run(seed_hamad_usecases())