...
# USER CONFIGURATION
USER_EMAIL = "hamza@iiotsolutions.sa"  # UPDATE THIS WITH ACTUAL EMAIL
USER_NAME = "Hamza Feroze"
JSON_FILE = "hamza_usecases.json"
...
async def seed_hamza_usecases():
    """Seeds use cases for Hamza Feroze from hamza_usecases.json"""
        ...
        for idx, case_json in enumerate(use_cases_data, 1):
            try:
                ...
                db_case = {
                    ...
                    "submitted_by": str(user.id),  # Assign to Hamza
                    "published": True,
                    "view_count": 0,
                    "like_count": 0,
                    "bookmark_count": 0,
...
if __name__ == "__main__":
    ...
    print("-" * 50)
    asyncio.run(seed_hamza_usecases())