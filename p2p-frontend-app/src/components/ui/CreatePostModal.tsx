...
import { Loader2, Send, MessageSquare, Tag, FileText, Sparkles, X } from "lucide-react";
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <Select onValueChange={setCategoryId}>
                  ...
                  <SelectContent className="rounded-xl bg-white border-2 border-slate-200 shadow-xl z-50">
                    {categories.map((cat) => (
                      <SelectItem key={cat.id} value={cat.id} className="text-base py-3 hover:bg-blue-50 cursor-pointer">
